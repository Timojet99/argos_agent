...
class MapCommIfSingletonFactory : virtual public MapCommIfFactory {
   public:
    explicit MapCommIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<MapCommIf>& iface) : iface_(iface) {}
    virtual ~MapCommIfSingletonFactory() {}

    virtual MapCommIf* getHandler(const ::apache::thrift::TConnectionInfo&) override { return iface_.get(); }
    virtual void releaseHandler(MapCommIf* /* handler */) override {}
...
class MapCommNull : virtual public MapCommIf {
   public:
    ...
    bool sendMapMessage(const MapMessage& /* map_complete */) override {
        bool _return = false;
        return _return;
    }
    bool sendCarPose(const CarMessage& /* car_pose */) override {
        bool _return = false;
        return _return;
    }
    bool sendThriftImage(const ThriftImage& /* image */) override {
        bool _return = false;
        return _return;
    }
};
...
class MapComm_ping_args {
   public:
    ...
    bool operator==(const MapComm_ping_args& /* rhs */) const { return true; }
    bool operator!=(const MapComm_ping_args& rhs) const { return !(*this == rhs); }
...
class MapComm_ping_result {
   public:
    ...
    bool operator==(const MapComm_ping_result& /* rhs */) const { return true; }
    bool operator!=(const MapComm_ping_result& rhs) const { return !(*this == rhs); }
...
class MapComm_sendMapMessage_args {
   public:
    ...
    bool operator==(const MapComm_sendMapMessage_args& rhs) const {
        if (!(map_complete == rhs.map_complete)) return false;
        return true;
    }
    bool operator!=(const MapComm_sendMapMessage_args& rhs) const { return !(*this == rhs); }
...
class MapComm_sendMapMessage_result {
   public:
    ...
    bool operator==(const MapComm_sendMapMessage_result& rhs) const {
        if (success == rhs.success) return true;
        return false;
    }
    bool operator!=(const MapComm_sendMapMessage_result& rhs) const { return !(*this == rhs); }
...
class MapComm_sendCarPose_args {
   public:
    ...
    bool operator==(const MapComm_sendCarPose_args& rhs) const {
        if (!(car_pose == rhs.car_pose)) return false;
        return true;
    }
    bool operator!=(const MapComm_sendCarPose_args& rhs) const { return !(*this == rhs); }
...
class MapComm_sendCarPose_result {
   public:
    ...
    bool operator!=(const MapComm_sendCarPose_result& rhs) const { return !(*this == rhs); }
...
class MapComm_sendThriftImage_args {
   public:
    ...
    bool operator!=(const MapComm_sendThriftImage_args& rhs) const { return !(*this == rhs); }
...
class MapComm_sendThriftImage_result {
   public:
    ...
    bool operator!=(const MapComm_sendThriftImage_result& rhs) const { return !(*this == rhs); }
...
class MapCommClient : virtual public MapCommIf {
   public:
    explicit MapCommClient(apache::thrift::stdcxx::shared_ptr<::apache::thrift::protocol::TProtocol> prot) {
        setProtocol(prot);
    }
    MapCommClient(apache::thrift::stdcxx::shared_ptr<::apache::thrift::protocol::TProtocol> iprot,
   ...
   public:
    apache::thrift::stdcxx::shared_ptr<::apache::thrift::protocol::TProtocol> getInputProtocol() { return piprot_; }
    apache::thrift::stdcxx::shared_ptr<::apache::thrift::protocol::TProtocol> getOutputProtocol() { return poprot_; }
    void ping() override;
    void send_ping();
    void recv_ping();
    bool sendMapMessage(const MapMessage& map_complete) override;
...
class MapCommProcessor : public ::apache::thrift::TDispatchProcessor {
   ...
   private:
    typedef void (MapCommProcessor::*ProcessFunction)(int32_t, ::apache::thrift::protocol::TProtocol*,
    ...
    void process_sendMapMessage(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot,
                                ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
    void process_sendCarPose(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot,
                             ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
    void process_sendThriftImage(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot,
                                 ::apache::thrift::protocol::TProtocol* oprot, void* callContext);

   public:
    explicit MapCommProcessor(::apache::thrift::stdcxx::shared_ptr<MapCommIf> iface) : iface_(iface) {
...
class MapCommProcessorFactory : public ::apache::thrift::TProcessorFactory {
   public:
    explicit MapCommProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr<MapCommIfFactory>& handlerFactory)
...
class MapCommMultiface : virtual public MapCommIf {
   public:
    explicit MapCommMultiface(const std::vector<apache::thrift::stdcxx::shared_ptr<MapCommIf>>& ifaces)
        : ifaces_(ifaces) {}
   ...
   protected:
    ...
    MapCommMultiface() {}
    void add(::apache::thrift::stdcxx::shared_ptr<MapCommIf> iface) { ifaces_.push_back(iface); }
...
class MapCommConcurrentClient : virtual public MapCommIf {
   public:
    explicit MapCommConcurrentClient(apache::thrift::stdcxx::shared_ptr<::apache::thrift::protocol::TProtocol> prot) {
        setProtocol(prot);
    }
    MapCommConcurrentClient(apache::thrift::stdcxx::shared_ptr<::apache::thrift::protocol::TProtocol> iprot,
                            apache::thrift::stdcxx::shared_ptr<::apache::thrift::protocol::TProtocol> oprot) {
        setProtocol(iprot, oprot);
    }
