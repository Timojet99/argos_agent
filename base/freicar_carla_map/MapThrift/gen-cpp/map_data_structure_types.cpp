...
int _kMessageOpValues[] = {MessageOp::ADD,    MessageOp::UPDATE_WHOLE, MessageOp::UPDATE_PART,
                           MessageOp::DELETE, MessageOp::POSE_UPDATE,  MessageOp::POSE_DELETE};
const char* _kMessageOpNames[] = {"ADD", "UPDATE_WHOLE", "UPDATE_PART", "DELETE", "POSE_UPDATE", "POSE_DELETE"};
const std::map<int, const char*> _MessageOp_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(6, _kMessageOpValues,
                                                                                            _kMessageOpNames),
...
int _kLaneMarkingTypeValues[] = {LaneMarkingType::SOLID, LaneMarkingType::DASHED, LaneMarkingType::CENTER_SOLID,
                                 LaneMarkingType::CENTER_DASHED};
const char* _kLaneMarkingTypeNames[] = {"SOLID", "DASHED", "CENTER_SOLID", "CENTER_DASHED"};
const std::map<int, const char*> _LaneMarkingType_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(4, _kLaneMarkingTypeValues, _kLaneMarkingTypeNames),
    ::apache::thrift::TEnumIterator(-1, NULL, NULL));
...
int _kLaneTypeValues[] = {LaneType::NORMAL, LaneType::CAR_LANE, LaneType::PEDESTRIAN_LANE};
const char* _kLaneTypeNames[] = {"NORMAL", "CAR_LANE", "PEDESTRIAN_LANE"};
const std::map<int, const char*> _LaneType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(3, _kLaneTypeValues,
                                                                                           _kLaneTypeNames),
                                                           ::apache::thrift::TEnumIterator(-1, NULL, NULL));
...
int _kLaneDirectionValues[] = {LaneDirection::RIGHT, LaneDirection::LEFT};
const char* _kLaneDirectionNames[] = {"RIGHT", "LEFT"};
const std::map<int, const char*> _LaneDirection_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(2,
                                                                                                _kLaneDirectionValues,
                                                                                                _kLaneDirectionNames),
                                                                ::apache::thrift::TEnumIterator(-1, NULL, NULL));
...
int _kLaneObjectTypeValues[] = {LaneObjectType::STOPLINE, LaneObjectType::CROSSWALK, LaneObjectType::PARKING,
                                LaneObjectType::SIGN};
const char* _kLaneObjectTypeNames[] = {"STOPLINE", "CROSSWALK", "PARKING", "SIGN"};
const std::map<int, const char*> _LaneObjectType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(4,
                                                                                                 _kLaneObjectTypeValues,
                                                                                                 _kLaneObjectTypeNames),
                                                                 ::apache::thrift::TEnumIterator(-1, NULL, NULL));
...
void Uuid::__set_uuid(const std::string& val) { this->uuid = val; }
...
uint32_t Uuid::read(::apache::thrift::protocol::TProtocol* iprot) {
    ...
    if (!isset_uuid) throw TProtocolException(TProtocolException::INVALID_DATA);
    return xfer;
}
...
Uuid::Uuid(const Uuid& other0) { uuid = other0.uuid; }
...
void Point3D::__set_x(const double val) { this->x = val; }

void Point3D::__set_y(const double val) { this->y = val; }

void Point3D::__set_z(const double val) { this->z = val; }
...
uint32_t Point3D::read(::apache::thrift::protocol::TProtocol* iprot) {
    ...
    if (!isset_x) throw TProtocolException(TProtocolException::INVALID_DATA);
    if (!isset_y) throw TProtocolException(TProtocolException::INVALID_DATA);
    if (!isset_z) throw TProtocolException(TProtocolException::INVALID_DATA);
    return xfer;
}
...
void Pose::__set_position(const Point3D& val) { this->position = val; }

void Pose::__set_orientation(const double val) { this->orientation = val; }
...
uint32_t Pose::read(::apache::thrift::protocol::TProtocol* iprot) {
    ...
    if (!isset_position) throw TProtocolException(TProtocolException::INVALID_DATA);
    if (!isset_orientation) throw TProtocolException(TProtocolException::INVALID_DATA);
    return xfer;
}
...
void Pivot::__set_id(const Uuid& val) { this->id = val; }

void Pivot::__set_pose(const Pose& val) { this->pose = val; }

void Pivot::__set_is_valid(const bool val) { this->is_valid = val; }
...
void Pivot::printTo(std::ostream& out) const {
    ...
    out << ", "
        << "pose=" << to_string(pose);
    out << ", "
        << "is_valid=" << to_string(is_valid);
    out << ")";
}

MapContainer::~MapContainer() throw() {}

void MapContainer::__set_map_parts(const std::vector<MapPart>& val) { this->map_parts = val; }

void MapContainer::__set_pivot(const Pivot& val) { this->pivot = val; }
...
uint32_t MapContainer::write(::apache::thrift::protocol::TProtocol* oprot) const {
    ...
    {
        xfer +=
            oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->map_parts.size()));
...
void MapContainer::printTo(std::ostream& out) const {
    ...
    out << ", "
        << "pivot=" << to_string(pivot);
    out << ")";
}

LaneObjectList::~LaneObjectList() throw() {}

void LaneObjectList::__set_stoplines(const std::vector<Stopline>& val) { this->stoplines = val; }

void LaneObjectList::__set_crosswalks(const std::vector<Crosswalk>& val) { this->crosswalks = val; }

void LaneObjectList::__set_parking_lots(const std::vector<Parking>& val) { this->parking_lots = val; }

void LaneObjectList::__set_roadsigns(const std::vector<Roadsign>& val) { this->roadsigns = val; }
...
uint32_t LaneObjectList::write(::apache::thrift::protocol::TProtocol* oprot) const {
    ...
    {
        xfer +=
            oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->stoplines.size()));
    ...
    {
        xfer +=
            oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->crosswalks.size()));
    ...
    xfer += oprot->writeFieldBegin("parking_lots", ::apache::thrift::protocol::T_LIST, 3);
    {
        xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT,
                                      static_cast<uint32_t>(this->parking_lots.size()));
    ...
    {
        xfer +=
            oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->roadsigns.size()));
...
void LaneObjectList::printTo(std::ostream& out) const {
    ...
    out << ", "
        << "crosswalks=" << to_string(crosswalks);
    out << ", "
        << "parking_lots=" << to_string(parking_lots);
    out << ", "
        << "roadsigns=" << to_string(roadsigns);
    out << ")";
}

MapPart::~MapPart() throw() {}

void MapPart::__set_lanes(const std::vector<Lane>& val) { this->lanes = val; }

void MapPart::__set_lane_groups(const std::vector<LaneGroup>& val) { this->lane_groups = val; }

void MapPart::__set_lane_markings(const std::vector<LaneMarking>& val) { this->lane_markings = val; }

void MapPart::__set_lane_objects(const LaneObjectList& val) { this->lane_objects = val; }
...
uint32_t MapPart::write(::apache::thrift::protocol::TProtocol* oprot) const {
    ...
    {
        xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT,
                                      static_cast<uint32_t>(this->lane_groups.size()));
    ...
    {
        xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT,
                                      static_cast<uint32_t>(this->lane_markings.size()));
...
void MapPart::printTo(std::ostream& out) const {
    ...
    out << ", "
        << "lane_groups=" << to_string(lane_groups);
    out << ", "
        << "lane_markings=" << to_string(lane_markings);
    out << ", "
        << "lane_objects=" << to_string(lane_objects);
    out << ")";
}

LaneMarking::~LaneMarking() throw() {}

void LaneMarking::__set_type(const LaneMarkingType::type val) { this->type = val; }

void LaneMarking::__set_points(const std::vector<Point3D>& val) { this->points = val; }

void LaneMarking::__set_id(const Uuid& val) { this->id = val; }

void LaneMarking::__set_visibility(const bool val) { this->visibility = val; }
...
uint32_t LaneMarking::read(::apache::thrift::protocol::TProtocol* iprot) {
    ...
    if (!isset_id) throw TProtocolException(TProtocolException::INVALID_DATA);
    return xfer;
}
...
void LaneMarkingContainer::__set_left(const std::vector<Uuid>& val) { this->left = val; }

void LaneMarkingContainer::__set_right(const std::vector<Uuid>& val) { this->right = val; }
...
void Lane::__set_lane_markings(const LaneMarkingContainer& val) { this->lane_markings = val; }

void Lane::__set_dir(const LaneDirection::type val) { this->dir = val; }

void Lane::__set_outgoing_connections(const std::vector<Uuid>& val) { this->outgoing_connections = val; }

void Lane::__set_incoming_connections(const std::vector<Uuid>& val) { this->incoming_connections = val; }

void Lane::__set_type(const LaneType::type val) { this->type = val; }

void Lane::__set_points(const std::vector<Point3D>& val) { this->points = val; }

void Lane::__set_width(const double val) { this->width = val; }

void Lane::__set_id(const Uuid& val) { this->id = val; }

void Lane::__set_handle_point(const Point3D& val) { this->handle_point = val; }

void Lane::__set_visibility(const bool val) { this->visibility = val; }

void Lane::__set_height(const int64 val) { this->height = val; }

void Lane::__set_junction_id(const int64 val) { this->junction_id = val; }
...
uint32_t Lane::write(::apache::thrift::protocol::TProtocol* oprot) const {
    ...
    {
        xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT,
                                      static_cast<uint32_t>(this->outgoing_connections.size()));
    ...
    {
        xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT,
                                      static_cast<uint32_t>(this->incoming_connections.size()));
...
void Lane::printTo(std::ostream& out) const {
    ...
    out << ", "
        << "dir=" << to_string(dir);
    out << ", "
        << "outgoing_connections=" << to_string(outgoing_connections);
    out << ", "
        << "incoming_connections=" << to_string(incoming_connections);
    out << ", "
        << "type=" << to_string(type);
    out << ", "
        << "points=" << to_string(points);
    ...
    out << ", "
        << "id=" << to_string(id);
    out << ", "
        << "handle_point=" << to_string(handle_point);
    out << ", "
        << "visibility=" << to_string(visibility);
    out << ", "
        << "height=" << to_string(height);
    out << ", "
        << "junction_id=" << to_string(junction_id);
    out << ")";
}

LaneGroup::~LaneGroup() throw() {}

void LaneGroup::__set_id(const Uuid& val) { this->id = val; }

void LaneGroup::__set_lanes_right(const std::vector<Uuid>& val) { this->lanes_right = val; }

void LaneGroup::__set_lanes_left(const std::vector<Uuid>& val) { this->lanes_left = val; }
...
uint32_t LaneGroup::write(::apache::thrift::protocol::TProtocol* oprot) const {
    ...
    {
        xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT,
                                      static_cast<uint32_t>(this->lanes_right.size()));
    ...
    {
        xfer +=
            oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->lanes_left.size()));
...
void LaneGroup::printTo(std::ostream& out) const {
    ...
    out << "id=" << to_string(id);
    out << ", "
        << "lanes_right=" << to_string(lanes_right);
    out << ", "
        << "lanes_left=" << to_string(lanes_left);
    out << ")";
}

LaneObjectBase::~LaneObjectBase() throw() {}

void LaneObjectBase::__set_id(const Uuid& val) { this->id = val; }

void LaneObjectBase::__set_type(const LaneObjectType::type val) { this->type = val; }

void LaneObjectBase::__set_lg_id(const Uuid& val) { this->lg_id = val; }

void LaneObjectBase::__set_l_ids(const std::vector<Uuid>& val) { this->l_ids = val; }

void LaneObjectBase::__set_offset(const double val) { this->offset = val; }
...
void LaneObjectBase::printTo(std::ostream& out) const {
    ...
    out << ", "
        << "type=" << to_string(type);
    out << ", "
        << "lg_id=" << to_string(lg_id);
    out << ", "
        << "l_ids=" << to_string(l_ids);
    out << ", "
...
void Stopline::__set_lane_object(const LaneObjectBase& val) { this->lane_object = val; }
...
uint32_t Stopline::read(::apache::thrift::protocol::TProtocol* iprot) {
    ...
    if (!isset_lane_object) throw TProtocolException(TProtocolException::INVALID_DATA);
    return xfer;
}
...
Stopline::Stopline(const Stopline& other130) { lane_object = other130.lane_object; }
...
void Crosswalk::__set_lane_object(const LaneObjectBase& val) { this->lane_object = val; }
...
Crosswalk::Crosswalk(const Crosswalk& other132) { lane_object = other132.lane_object; }
...
void Parking::__set_lane_object(const LaneObjectBase& val) { this->lane_object = val; }

void Parking::__set_number_of_lots(const int64 val) { this->number_of_lots = val; }

void Parking::__set_parking_height(const double val) { this->parking_height = val; }

void Parking::__set_parking_width(const double val) { this->parking_width = val; }

void Parking::__set_line_width(const double val) { this->line_width = val; }

void Parking::__set_outer_points(const std::vector<std::vector<Point3D>>& val) { this->outer_points = val; }
...
uint32_t Parking::write(::apache::thrift::protocol::TProtocol* oprot) const {
    ...
    {
        xfer +=
            oprot->writeListBegin(::apache::thrift::protocol::T_LIST, static_cast<uint32_t>(this->outer_points.size()));
        ...
        for (_iter144 = this->outer_points.begin(); _iter144 != this->outer_points.end(); ++_iter144) {
            {
                xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT,
                                              static_cast<uint32_t>((*_iter144).size()));
...
void Parking::printTo(std::ostream& out) const {
    ...
    out << "lane_object=" << to_string(lane_object);
    out << ", "
        << "number_of_lots=" << to_string(number_of_lots);
    out << ", "
        << "parking_height=" << to_string(parking_height);
    out << ", "
        << "parking_width=" << to_string(parking_width);
    out << ", "
        << "line_width=" << to_string(line_width);
    out << ", "
        << "outer_points=" << to_string(outer_points);
    out << ")";
}

Roadsign::~Roadsign() throw() {}

void Roadsign::__set_lane_object(const LaneObjectBase& val) { this->lane_object = val; }

void Roadsign::__set_sign_type(const std::string& val) { this->sign_type = val; }

void Roadsign::__set_position(const Point3D& val) { this->position = val; }

void Roadsign::__set_rotation(const double val) { this->rotation = val; }
...
void PointViz::__set_point(const Point3D& val) { this->point = val; }

void PointViz::__set_radius(const double val) { this->radius = val; }
...
uint32_t PointViz::read(::apache::thrift::protocol::TProtocol* iprot) {
    ...
    if (!isset_point) throw TProtocolException(TProtocolException::INVALID_DATA);
    if (!isset_radius) throw TProtocolException(TProtocolException::INVALID_DATA);
    return xfer;
}
...
void MapMessage::__set_op(const MessageOp::type val) { this->op = val; }

void MapMessage::__set_container(const MapContainer& val) { this->container = val; }
...
uint32_t MapMessage::read(::apache::thrift::protocol::TProtocol* iprot) {
    ...
    if (!isset_op) throw TProtocolException(TProtocolException::INVALID_DATA);
    if (!isset_container) throw TProtocolException(TProtocolException::INVALID_DATA);
    return xfer;
}
...
void CarMessage::__set_op(const MessageOp::type val) { this->op = val; }

void CarMessage::__set_pose(const Pose& val) { this->pose = val; }

void CarMessage::__set_n_points_viz(const int64 val) { this->n_points_viz = val; }

void CarMessage::__set_points_viz(const std::vector<PointViz>& val) { this->points_viz = val; }
...
uint32_t CarMessage::read(::apache::thrift::protocol::TProtocol* iprot) {
    ...
    if (!isset_op) throw TProtocolException(TProtocolException::INVALID_DATA);
    if (!isset_pose) throw TProtocolException(TProtocolException::INVALID_DATA);
    if (!isset_n_points_viz) throw TProtocolException(TProtocolException::INVALID_DATA);
    if (!isset_points_viz) throw TProtocolException(TProtocolException::INVALID_DATA);
    return xfer;
}
...
uint32_t CarMessage::write(::apache::thrift::protocol::TProtocol* oprot) const {
    ...
    {
        xfer +=
            oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->points_viz.size()));
...
void CarMessage::printTo(std::ostream& out) const {
    ...
    out << ", "
        << "pose=" << to_string(pose);
    out << ", "
        << "n_points_viz=" << to_string(n_points_viz);
    out << ", "
        << "points_viz=" << to_string(points_viz);
    out << ")";
}

ThriftImage::~ThriftImage() throw() {}

void ThriftImage::__set_width(const int16_t val) { this->width = val; }

void ThriftImage::__set_height(const int16_t val) { this->height = val; }

void ThriftImage::__set_channels(const int8_t val) { this->channels = val; }

void ThriftImage::__set_bytes(const std::string& val) { this->bytes = val; }

void ThriftImage::__set_pose(const Pose& val) { this->pose = val; }
...
uint32_t ThriftImage::read(::apache::thrift::protocol::TProtocol* iprot) {
    ...
    if (!isset_width) throw TProtocolException(TProtocolException::INVALID_DATA);
    if (!isset_height) throw TProtocolException(TProtocolException::INVALID_DATA);
    if (!isset_channels) throw TProtocolException(TProtocolException::INVALID_DATA);
    if (!isset_bytes) throw TProtocolException(TProtocolException::INVALID_DATA);
    if (!isset_pose) throw TProtocolException(TProtocolException::INVALID_DATA);
    return xfer;
}
