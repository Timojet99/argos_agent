...
AgentMapInfo::AgentMapInfo(const std::string& name_in, const std::string& lane_uuid_in, float l_offset,
...
float AgentMapInfo::vx() const { return velocity_.x; }
float AgentMapInfo::vy() const { return velocity_.y; }
float AgentMapInfo::vz() const { return velocity_.z; }
float AgentMapInfo::GetVelocityScalar() const { return velocity_scalar_; }
geometry_msgs::Vector3 AgentMapInfo::GetVelocityVector() const { return velocity_; }
