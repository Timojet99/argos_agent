...
namespace freicar {
namespace helper {
inline float ToScalar(const geometry_msgs::Vector3& v3) { return std::sqrt(v3.x * v3.x + v3.y * v3.y + v3.z * v3.z); }
...
struct AgentMapInfo {
   public:
    AgentMapInfo();
    AgentMapInfo(const std::string& name_in, const std::string& lane_uuid_in, float l_offset,
